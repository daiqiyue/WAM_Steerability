    ...
    def init_norm(
        ...
        if states_path is None:
            states_path = os.environ.get(
                "QWENPI_NORM_STATS_PATH",
                "/path/to/qwenpi/norm_stats.json",
            )
    ...
    def load_vla(self, path_to_pi_model) -> QwenPI0Policy:
        ...
        dataset = build_vla_dataset(
            ...
            repo_id=os.environ.get(
                "QWENPI_LEROBOT_REPO",
                "/path/to/lerobot/hanging_mug-aloha-agilex_clean_50_rep",
            ),
            config=config,
            chunk_size=50,
            tokenizer=tokenizer,
...
if __name__ == "__main__":
    ...
    PATH_TO_PI_MODEL = os.environ.get(
        "QWENPI_MODEL_PATH",
        "/path/to/qwenpi/checkpoints/global_step_35000/hf_ckpt",
    )
