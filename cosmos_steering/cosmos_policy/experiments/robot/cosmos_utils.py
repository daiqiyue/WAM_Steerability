...
def download_hf_checkpoint(repo_id: str, cache_dir: str | None = None) -> str:
    ...
    # Honor HF_HUB_CACHE first (proper HF semantics); fall back to a
    # caller-supplied cache_dir. If neither is set, the HF library uses
    # its own default ($HF_HOME/hub or ~/.cache/huggingface/hub).
